"""Vul specifiek de historische Telraam-data van Coupure Links uit 2019 aan.

Eenmalig/gericht backfillscript voor het deel van 2019 dat niet door de algemene
backfill vanaf 2020 wordt afgedekt."""
...
TARGETS = [
    ("Coupure Links", 155401,
     datetime(2019, 11, 26, tzinfo=timezone.utc),
...
def main():
    print("=" * 72)
    print("STRAATVIZIER - AANVULLENDE BACKFILL COUPURE LINKS 2019")
    print("=" * 72)
